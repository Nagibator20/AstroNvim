return {
  ...
  --       floating_window_above_cur_line = false, -- Размещает плавающий элемент над строкой
  ...
  --       floating_window_off_y = -2, -- корректировка позиции y всплывающих окон. Например, -2 перемещает окно на 2 строки вверх;
